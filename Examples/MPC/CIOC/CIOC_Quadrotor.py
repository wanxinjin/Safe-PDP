...
for k in range(max_iter):
    ...
    for i in range(batch_size):
        ...
        auxsys_COC = coc.getAuxSys(opt_sol=traj_COC, threshold=1e-2)
        clqr.auxsys2Eqctlqr(auxsys=auxsys_COC)
        aux_sol_COC = clqr.eqctlqrSolver(threshold=1e-2)
...
if True:
    ...
    np.save('./Results/CIOC_Quadrotor_trial_1.npy', save_data)
