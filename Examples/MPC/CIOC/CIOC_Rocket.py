...
for k in range(max_iter):
    ...
    for i in range(batch_size):
        ...
        auxsys_COC = coc.getAuxSys(opt_sol=traj_COC, threshold=1e-1)
        clqr.auxsys2Eqctlqr(auxsys=auxsys_COC)
        aux_sol_COC = clqr.eqctlqrSolver(threshold=1e-1)
...
if True:
    ...
    np.save('./Results/CIOC_Rocket_trial_1.npy', save_data)