...
load = np.load('./CODE_Rocket_trial_1.npy', allow_pickle=True).item()
gamma = load['gamma']
...
env.initCost(wr=data['wr'], wv=data['wv'], wtilt=data['wtilt'], ww=data['ww'], wsidethrust=data['wsidethrust'],
             wthrust=0.4)
...
ax1.set_position([0.18, 0.13, 0.78, 0.84])
